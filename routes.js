...
FlowRouter.route('/', {
  name: 'mainPage',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName);
  }
});
...
announcementRoute.route('/', {
  ...
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 系統公告`);
  }
});
announcementRoute.route('/view/:announcementId', {
  name: 'announcementDetail',
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 系統公告內容`);
  }
});
announcementRoute.route('/reject/:announcementId', {
  name: 'rejectAnnouncement',
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 系統公告否決`);
  }
});
...
violationRoute.route('/', {
  ...
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 違規案件列表`);
  }
});
violationRoute.route('/report', {
  name: 'reportViolation',
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 舉報違規`);
  }
});
violationRoute.route('/view/:violationCaseId', {
  name: 'violationCaseDetail',
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 違規案件內容`);
  }
});
...
FlowRouter.route('/fscLogs', {
  name: 'fscLogs',
  action() {
    DocHead.setTitle(`${Meteor.settings.public.websiteInfo.websiteName} - 違規處置紀錄`);
  }
});
...
FlowRouter.route('/fscStock', {
  name: 'fscStock',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 金管會持股');
  }
});
...
FlowRouter.route('/tutorial', {
  name: 'tutorial',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 遊戲規則');
  }
});
...
companyRoute.route('/:page', {
  name: 'companyList',
  action(params) {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 股市總覽');
    if (Meteor.isClient) {
...
companyRoute.route('/detail/:companyId', {
  ...
  action(params) {
    if (Meteor.isServer) {
      ...
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 「' + companyArchiveData.companyName + '」公司資訊');
    }
    else {
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 公司資訊');
    }
  }
});
...
productCenterRoute.route('/season/:seasonId', {
  ...
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 產品中心');
  }
});
productCenterRoute.route('/company/:companyId', {
  ...
  action(params) {
    if (Meteor.isServer) {
      ...
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 產品中心 - ' + companyArchiveData.companyName);
    }
    else {
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 產品中心');
    }
...
FlowRouter.route('/advertising', {
  name: 'advertising',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 廣告宣傳');
  }
});
...
arenaInfoRoute.route('/', {
  ...
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 最萌亂鬥大賽');
  }
});
...
seasonalReportRoute.route('/', {
  ...
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 季度報告');
  }
});
...
accountInfoRoute.route('/:userId', {
  ...
  action(params) {
    if (Meteor.isServer) {
      ...
      DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 帳號資訊');
    }
  }
});
...
ruleDiscussRoute.route('/list', {
  name: 'ruleAgendaList',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 規則討論');
  }
});
ruleDiscussRoute.route('/view/:agendaId', {
  name: 'ruleAgendaDetail',
  action() {
    DocHead.setTitle(Meteor.settings.public.websiteInfo.websiteName + ' - 議程資訊');
  }
});
